...
if (n == 2){
 ...
 //ROOT::RDataFrame d("Events", "/dev/shm/millerca/l1Nano_WTo3Pion_PU200_iso.root");
    ...
    //ROOT::RDataFrame d("Events", "/dev/shm/millerca/l1Nano_TTbar_PU200_iso_comp0.root");
    auto d2 = d.Filter(initptcut, {"L1Puppi_pt","L1Puppi_pdgId"}, "Initial Cut")
        .Define("Triplet_Index", maketriplets, {"L1Puppi_pdgId", "L1Puppi_charge", "L1Puppi_pt", "L1Puppi_eta", "L1Puppi_phi", "L1Puppi_mass"})
        .Filter(notempty,{"Triplet_Index"})
        .Define("Triplet_Mass",tripletmass,{"Triplet_Index", "L1Puppi_pt", "L1Puppi_eta", "L1Puppi_phi", "L1Puppi_mass"}); //simulates analysis on 1 orbit
...
//single neutrino
    ...
    //ROOT::RDataFrame d("Events", "/dev/shm/millerca/l1Nano_SingleNeutrino_PU200_iso_comp0.root");
    auto d2 = d.Filter(initptcut, {"L1Puppi_pt","L1Puppi_pdgId"},"Initial Cut")
        .Define("Triplet_Index", maketriplets, {"L1Puppi_pdgId", "L1Puppi_charge", "L1Puppi_pt", "L1Puppi_eta", "L1Puppi_phi", "L1Puppi_mass"})
        .Filter(notempty,{"Triplet_Index"})
        .Define("Triplet_Mass",tripletmass,{"Triplet_Index", "L1Puppi_pt", "L1Puppi_eta", "L1Puppi_phi", "L1Puppi_mass"}); //simulates analysis on 1 orbit
